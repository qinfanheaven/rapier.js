...
export class RawColliderSet {
     ...
     */
    coVertices(handle) {
        const ret = wasm.rawcolliderset_coVertices(this.__wbg_ptr, handle);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    coIndices(handle) {
        const ret = wasm.rawcolliderset_coIndices(this.__wbg_ptr, handle);
        let v1;
        if (ret[0] !== 0) {
    ...
    coHeightfieldHeights(handle) {
        const ret = wasm.rawcolliderset_coHeightfieldHeights(this.__wbg_ptr, handle);
        let v1;
        if (ret[0] !== 0) {
            v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
     ...
     */
    coParent(handle) {
        const ret = wasm.rawcolliderset_coParent(this.__wbg_ptr, handle);
    ...
    createCollider(enabled, shape, translation, rotation, massPropsMode, mass, centerOfMass, principalAngularInertia, angularInertiaFrame, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, contactForceEventThreshold, contactSkin, hasParent, parent, bodies) {
        ...
        const ret = wasm.rawcolliderset_createCollider(this.__wbg_ptr, enabled, shape.__wbg_ptr, translation.__wbg_ptr, rotation.__wbg_ptr, massPropsMode, mass, centerOfMass.__wbg_ptr, principalAngularInertia.__wbg_ptr, angularInertiaFrame.__wbg_ptr, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, contactForceEventThreshold, contactSkin, hasParent, parent, bodies.__wbg_ptr);
        return ret[0] === 0 ? undefined : ret[1];
    }
    /**
    ...
    forEachColliderHandle(f) {
        wasm.rawcolliderset_forEachColliderHandle(this.__wbg_ptr, f);
    }
}
...
export class RawDynamicRayCastVehicleController {
    ...
    update_vehicle(dt, bodies, colliders, queries, filter_flags, filter_groups, filter_predicate) {
        ...
        wasm.rawdynamicraycastvehiclecontroller_update_vehicle(this.__wbg_ptr, dt, bodies.__wbg_ptr, colliders.__wbg_ptr, queries.__wbg_ptr, filter_flags, isLikeNone(filter_groups) ? 0x100000001 : (filter_groups) >>> 0, filter_predicate);
    }
    /**
     * @param {number} i
     * @returns {RawVector | undefined}
    ...
    wheel_ground_object(i) {
        const ret = wasm.rawdynamicraycastvehiclecontroller_wheel_ground_object(this.__wbg_ptr, i);
        return ret[0] === 0 ? undefined : ret[1];
    }
}
...
export class RawEventQueue {
    ...
    drainCollisionEvents(f) {
        wasm.raweventqueue_drainCollisionEvents(this.__wbg_ptr, f);
    }
    /**
     * @param {Function} f
     */
    drainContactForceEvents(f) {
        wasm.raweventqueue_drainContactForceEvents(this.__wbg_ptr, f);
    }
    /**
...
export class RawImpulseJointSet {
    ...
    forEachJointHandle(f) {
        wasm.rawimpulsejointset_forEachJointHandle(this.__wbg_ptr, f);
    }
    /**
    ...
    forEachJointAttachedToRigidBody(body, f) {
        wasm.rawimpulsejointset_forEachJointAttachedToRigidBody(this.__wbg_ptr, body, f);
    }
}
...
export class RawIslandManager {
    ...
    forEachActiveRigidBodyHandle(f) {
        wasm.rawislandmanager_forEachActiveRigidBodyHandle(this.__wbg_ptr, f);
    }
}
...
export class RawMultibodyJointSet {
     ...
     */
    forEachJointHandle(f) {
        wasm.rawmultibodyjointset_forEachJointHandle(this.__wbg_ptr, f);
    }
    /**
     * Applies the given JavaScript function to the integer handle of each joint attached to the given rigid-body.
     *
     ...
     */
    forEachJointAttachedToRigidBody(body, f) {
        wasm.rawmultibodyjointset_forEachJointAttachedToRigidBody(this.__wbg_ptr, body, f);
    }
}
...
export class RawNarrowPhase {
    ...
    contact_pairs_with(handle1, f) {
        wasm.rawnarrowphase_contact_pairs_with(this.__wbg_ptr, handle1, f);
    }
    /**
     * @param {number} handle1
    ...
    intersection_pairs_with(handle1, f) {
        wasm.rawnarrowphase_intersection_pairs_with(this.__wbg_ptr, handle1, f);
    }
    /**
     * @param {number} handle1
     * @param {number} handle2
...
export class RawQueryPipeline {
    ...
    intersectionsWithRay(bodies, colliders, rayOrig, rayDir, maxToi, solid, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        ...
        _assertClass(rayOrig, RawVector);
        _assertClass(rayDir, RawVector);
        wasm.rawquerypipeline_intersectionsWithRay(this.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, rayOrig.__wbg_ptr, rayDir.__wbg_ptr, maxToi, solid, callback, filter_flags, isLikeNone(filter_groups) ? 0x100000001 : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, filter_predicate);
    }
    /**
     * @param {RawRigidBodySet} bodies
     * @param {RawColliderSet} colliders
    ...
    intersectionsWithPoint(bodies, colliders, point, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        ...
        _assertClass(colliders, RawColliderSet);
        _assertClass(point, RawVector);
        wasm.rawquerypipeline_intersectionsWithPoint(this.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, point.__wbg_ptr, callback, filter_flags, isLikeNone(filter_groups) ? 0x100000001 : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, filter_predicate);
    }
    /**
     * @param {RawRigidBodySet} bodies
     * @param {RawColliderSet} colliders
    ...
    intersectionsWithShape(bodies, colliders, shapePos, shapeRot, shape, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        ...
        _assertClass(shapeRot, RawRotation);
        _assertClass(shape, RawShape);
        wasm.rawquerypipeline_intersectionsWithShape(this.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, shapePos.__wbg_ptr, shapeRot.__wbg_ptr, shape.__wbg_ptr, callback, filter_flags, isLikeNone(filter_groups) ? 0x100000001 : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, filter_predicate);
    }
    /**
    ...
    collidersWithAabbIntersectingAabb(aabbCenter, aabbHalfExtents, callback) {
        ...
        wasm.rawquerypipeline_collidersWithAabbIntersectingAabb(this.__wbg_ptr, aabbCenter.__wbg_ptr, aabbHalfExtents.__wbg_ptr, callback);
    }
}
...
export class RawRigidBodySet {
    ...
    forEachRigidBodyHandle(f) {
        wasm.rawrigidbodyset_forEachRigidBodyHandle(this.__wbg_ptr, f);
    }
    /**
     * @param {RawColliderSet} colliders
     */
...
export class RawSerializationPipeline {
     ...
     */
    deserializeAll(data) {
        const ret = wasm.rawserializationpipeline_deserializeAll(this.__wbg_ptr, data);
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_bind_a735f62d385d448f = function(arg0, arg1, arg2, arg3) {
    ...
    imports.wbg.__wbg_length_efb03223ba0f7330 = function(arg0) {
        const ret = arg0.length;
        return ret;
    };
    ...
    imports.wbg.__wbg_newwithlength_1efb4a1a79af5a72 = function(arg0) {
    ...
    imports.wbg.__wbg_set_682e6e997e17e6df = function(arg0, arg1, arg2) {
        arg0.set(arg1, arg2 >>> 0);
    };
